  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          elevation: 1,
          title: Text('Add Adress' , style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold,fontFamily: 'Poppins', color: Colors.black),),
                ...
                child: Form(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 15.0,),
                        TextUtils(text: 'Street Address 2 (Optional)', fontSize: AppSize.s14, fontWeight: FontWeight.bold, color: ColorManager.bBlack),
                        SizedBox(
                          height: AppSize.s10,
                        ),
                        FormFieldAddress(
                        ...
                        SizedBox(height: 15.0,),
                        TextUtils(text: 'State/Province/Region', fontSize: AppSize.s14, fontWeight: FontWeight.bold, color: ColorManager.bBlack),
                        SizedBox(
                          height: AppSize.s10,
                        ),
                        FormFieldAddress(
                        ...
                        SizedBox(height: 15.0,),
                        TextUtils(text:'City', fontSize: AppSize.s14, fontWeight: FontWeight.bold, color: ColorManager.bBlack),
                        SizedBox(
                          height: AppSize.s10,
                        ),
                        ...
                        SizedBox(height: 15.0,),
                        TextUtils(text: 'Zip Code', fontSize: AppSize.s14, fontWeight: FontWeight.bold, color: ColorManager.bBlack),
                        SizedBox(
                          height: AppSize.s10,
                        ),
                        ...
                        TextUtils(text: 'Phone Number', fontSize: AppSize.s14, fontWeight: FontWeight.bold, color: ColorManager.bBlack),
                        SizedBox(
                          height: AppSize.s10,
                        ),
                        FormFieldAddress(
